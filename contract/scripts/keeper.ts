...
async function main() {
  ...
  const upkeep = "0x4784a9C3a08040104Ce87E62C0525836063E3EFb";
  ...
  const tx1 = await linkToken.transferAndCall("0x9806cf6fbc89abf286e8140c42174b94836e36f2", amount, abiEncodedBytes);
  await tx1.wait();
